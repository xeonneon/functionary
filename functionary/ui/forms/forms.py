...
from core.models import Environment, Function, Package, ScheduledTask
...
class ScheduledTaskForm(ModelForm):
    # Reference: https://django-celery-beat.readthedocs.io/en/latest/_modules/django_celery_beat/models.html#CrontabSchedule.from_schedule
    ...
    def clean(self):
        ...
        if cleaned_data["function"] not in available_functions:
            raise ValueError("Unknown function was provided.")
